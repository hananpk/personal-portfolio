...
const StepCard = (props) => {
  const { id, i, name, tools, description, color, progress, range, targetScale } = props
  ...
  return (
    <div ref={container} className={`${Style.card_container} card`}>
      <motion.div className={`${Style.card} ${Style[className]} border border-white/5`} style={{ scale, opacity, top: `calc(-5vh + ${i * 25}px)` }}>
      <div className="">
